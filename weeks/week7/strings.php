...
$statement= 'presently, I am reading the Looning Tower';
echo $statement;
echo '<br>';
...
echo '<h2>What if I would like to display Looning?</h2>';
...
$statement2 = 'Hulu\s rendition of the looning tower is based on the book named the looming tower! ';
