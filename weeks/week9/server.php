<?php
//this is my server page that will be comunicating to the data base
...
//we will also be using a new function wich is mysqli_real_escape_string
...
if(isset($_POST['reg_user'])) {
    ...
    //introduction a new function- array_push();
    ...
    if((int)$errors == 0) {
        ...
        //logically - we have to insert the information onto our database
