...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
     ...
     $_POST['bank'])) {
        ...
        if($dollars >= 2000) {
            echo '<h2 class="message">I am REALLY happy, because I have $'.number_format($dollars, 2).' American dollars!</h2>';
            echo '<iframe src="https://www.youtube.com/embed/OzvJDcFVRYc" frameborder="0" allowfullscreen></iframe>';
        } else {
            echo '<h2 class="message">I am NOT happy, because I have $'.number_format($dollars, 2).' American dollars!</h2>';
            echo '<iframe src="https://www.youtube.com/embed/zJX8XxHOfrk" frameborder="0" allowfullscreen></iframe>';
